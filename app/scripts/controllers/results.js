 ...
 */
angular.module('fdagoApp').controller('ResultsCtrl', ['$q', '$scope', '$location', 'fdaGoQueryService', 'queryUtil', function($q, $scope, $location, fdaGoQueryService, util) {
    // set canvas id
    ...
    $scope.submitQuery = function() {
        ...
        $q.all(promises).finally(function() {
            if ($scope.eventResults.length + $scope.labelingResults.length + $scope.recallResults.length === 0){
